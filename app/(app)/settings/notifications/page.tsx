  ...
  return (
    <>
      <div className="space-y-8 pb-20">
        {/* Header */}
        <div>
          <h1 className="text-xs font-heading font-semibold">Notificações</h1>
        ...
        >
          <SettingsCard title="Notificações por Email" icon={Mail01Icon}>
            <div className="space-y-4">
              <div className="space-y-4">
                <div>
                  <h4 className="text-xs font-medium mb-2">Clientes e Projetos</h4>
                ...
                <div className="pt-4 border-t">
                  <h4 className="text-xs font-medium mb-2">Tarefas</h4>
                  <div className="space-y-3">
                    <SettingsToggle
                ...
                <div className="pt-4 border-t">
                  <h4 className="text-xs font-medium mb-2">Equipe e Relatórios</h4>
                  <div className="space-y-3">
                    <SettingsToggle
                ...
                <div className="pt-4 border-t">
                  <h4 className="text-xs font-medium mb-2">Marketing</h4>
                  <div className="space-y-3">
                    <SettingsToggle
          ...
          <SettingsCard title="Horários" icon={Clock01Icon}>
            <div className="space-y-4">
              ...
              {schedule.doNotDisturb && (
                <div className="grid gap-4 sm:grid-cols-2 pl-6 border-l-2">
                  <div className="space-y-2">
                    <Label htmlFor="startTime" className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60">
                      Início
                    </Label>
                    <input
                      id="startTime"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="endTime" className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground/60">
                      Término
                    </Label>
                    <input
                      id="endTime"
